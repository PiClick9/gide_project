 ...
 *   node build-pdf.mjs
 *
 * Screenshots are read from ./shots, so run capture.mjs first if they are
 * missing or stale. Output lands in the gide_project root.
 */
...
const OUTPUT = resolve(HERE, '..', 'AEDI-V-DASHBOARD_사용가이드.pdf')
...
const footer = `
  <div style="width:100%;padding:0 13mm;font-family:'Malgun Gothic',sans-serif;
    ...
    <span>AEDI-V Dashboard 사용 가이드</span>
